...
function print3(){
	$.post("{{ url('printtabungan/cetak') }}", 
            ...
            function(data, status){
                ...
                document.getElementsByName("printmodal2")[0].removeAttribute("data-toggle");
                document.getElementsByName("printmodal2")[0].removeAttribute("data-target");
                document.getElementsByName("printmodal2")[0].setAttribute("data-dismiss",'modal');
