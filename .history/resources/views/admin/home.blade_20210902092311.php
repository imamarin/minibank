                    ...
                    <div>
                      ...
                      <div class="">
                        <div class="progress progress_sm" style="width: 76%;">
                          <?php
                            $s = $setor/$nasabahaktif*100;
                          ?>
                          <div class="progress-bar bg-green" role="progressbar" data-transitiongoal="{{ $s }}">{{ $setor }}</div>
                        </div>
                      </div>
                    </div>
                    <div>
                      ...
                      <div class="">
                        <div class="progress progress_sm" style="width: 76%;">
                        <?php
                            $t = $tarik/$nasabahaktif*100;
                          ?>
                          <div class="progress-bar bg-green" role="progressbar" data-transitiongoal="{{ $t }}">{{ $tarik }}</div>
                        </div>
                      </div>
                    </div>
                  </div>
