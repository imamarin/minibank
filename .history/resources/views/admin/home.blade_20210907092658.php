                    ...
                    <div>
                      ...
                      <div class="">
                        <div class="progress progress_sm" style="width: 76%;">
                          ...
                          ?>
                          <div class="progress-bar bg-green" role="progressbar" data-transitiongoal="{{ $s }}"></div>{{ $s }} %
                        </div>
                      </div>
                    </div>
                    <div>
                      ...
                      <div class="">
                        ...
                        <?php
                          ...
                          ?>
                          <div class="progress-bar bg-green" role="progressbar" data-transitiongoal="{{ $t }}"></div>{{ $t }} %
                        </div>
                      </div>
                    </div>
                  </div>
