                ...
                <div class="col-md-3 col-sm-3  bg-white">
                  <div class="x_title">
                    ...
                    <?php
                      ...
                      $s = number_format($setor->nom/$total*100,2,",","");
                      $t =  number_format($tarik->nom/$total*100,2,",","");
                    ?>
                  ...
                  <div class="col-md-12 col-sm-12 ">
                    <div>
                      <p>Setoran - Rp. {{ number_format($setor->nom,0,",",".") }} ({{ $s }} %)</p>
                      <div class="">
                    ...
                    <div>
                      <p>Penarikan - Rp. {{ number_format($tarik->nom,0,",",".") }} ({{ $t }} %)</p>
                      <div class="">
                        <div class="progress progress_sm" style="width: 76%;">
