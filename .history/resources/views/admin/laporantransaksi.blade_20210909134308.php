...
<script>
    document.getElementById('kredit').innerHTML=': Rp. {{ $kredit }}';
    document.getElementById('debit').innerHTML=': Rp. {{ $debit }}';
    document.getElementById('transfer').innerHTML=': Rp. {{ $transfer }}';
</script>
