    ...
    <tbody>
        ...
        @foreach($transaksi as $data)
            ...
            <tr style="height:30px;">
                ...
                <td style="width: 65px;text-align:center;">{{ $data->sandi }}</td>
                <td style="width: 115px;text-align:right;">{{ $debit }}</td>
                <td style="width: 115px;text-align:right;">{{ $kredit  }}</td>
                <td style="width: 115px;text-align:right;">{{ $saldo }}</td>
