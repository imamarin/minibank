                                        ...
                                        <tbody>
                                            ...
                                            @foreach($tagihan as $data)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#" onclick="batal('{{ $data->nomor_induk }}','{{ $data->id_record_tagihan }}','{{ $data->total_nilai_tagihan }}')" class="btn btn-danger">Batalkan</a> 
                                                        <a href="#" onclick="inquiry('{{ $data->nomor_induk }}','{{ $data->id_record_tagihan }}','{{ $data->total_nilai_tagihan }}')" class="btn btn-info">Cek Tagihan</a>
