...
<div class="content-wrapper" align="center" style="margin-bottom:0px;">
    <section class="content" style="padding-left:0;padding-right:0;">
      <div class="container-fluid" style="padding-left:0;padding-right:0;">
        ...
        <div class="row">
          <div class="col-6">
                <a class="btn btn-app"  style="width:150px; height:100px;padding-top:25px;" href="{{ url('nasabah/inforek') }}">
                  <i class="fas fa-file-invoice text-yellow " style="font-size:30px;"></i> Info Rekening
                </a>
          </div>
          <div class="col-6">
          <a class="btn btn-app"  style="width:150px; height:100px;padding-top:25px;" href="{{ url('nasabah/transfer') }}">
        ...
        <div class="row">
          <div class="col-6">
          <a class="btn btn-app"  style="width:150px; height:100px;padding-top:25px;" href="{{ url('nasabah/pembayaran') }}">
                  <i class="fas fa-coins text-info" style="font-size:30px;"></i> Pembayaran
                </a>
          </div>
          <div class="col-6">
                <a class="btn btn-app"  style="width:150px; height:100px;padding-top:25px;">
