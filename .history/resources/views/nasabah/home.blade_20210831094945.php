...
<div class="content-wrapper" align="center" style="margin-bottom:0px;">
    ...
    <div class="row">
            <div class="col-4">
                  <a class="btn btn-app"  style="width:80%; height:90px;padding-top:25px;" href="{{ url('nasabah/inforek') }}">
                    <i class="fas fa-file-invoice text-yellow " style="font-size:30px;"></i> Info Rekening
                  </a>
            </div>
            <div class="col-4">
                  <a class="btn btn-app"  style="width:80%; height:90px;padding-top:25px;" href="{{ url('nasabah/transfer') }}">
                    <i class="fas fa-upload text-primary" style="font-size:30px;"></i> Transfer
                  </a>
            </div>
            <div class="col-4">
                  <a class="btn btn-app"  style="width:80%; height:90px;padding-top:25px;" href="{{ url('nasabah/pembayaran') }}">
