...
<div class="content-wrapper" align="center" style="margin-bottom:0px;">
    <section class="content" style="padding-left:0;padding-right:0;margin:0">
      <div class="container" style="padding-left:0;padding-right:0;" style="width:100%;">
    ...
    <div style="display:flex;justify-content:center;flex-wrap: wrap; margin-left:-5px;margin-right:15px;">
            <div class="row">
              <div class="col-4">
                    <a class="btn btn-app"  style="width:100%; height:100px;padding-top:25px;" href="{{ url('nasabah/inforek') }}">
                      <i class="fas fa-file-invoice text-yellow " style="font-size:30px;"></i> Info Rekening
                    </a>
              </div>
              <div class="col-4">
                    <a class="btn btn-app"  style="width:100%; height:100px;padding-top:25px;" href="{{ url('nasabah/transfer') }}">
                      <i class="fas fa-upload text-primary" style="font-size:30px;"></i> Transfer
                    </a>
              </div>
              <div class="col-4">
                    <a class="btn btn-app"  style="width:100%; height:100px;padding-top:25px;" href="{{ url('nasabah/pembayaran') }}">
                      <i class="fas fa-coins text-info" style="font-size:30px;"></i> Pembayaran
                    </a>
              </div>
              <div class="col-4">
                    <a class="btn btn-app"  style="width:100%; height:100px;padding-top:25px;">
                      <i class="fas fa-cash-register text-red" style="font-size:30px;"></i> Beli
                    </a>
              </div>
              <div class="col-4">
                    <a class="btn btn-app"  style="width:100%; height:100px;padding-top:25px;" href="{{ url('nasabah/') }}">
                      <i class="fas fa-file-import text-success" style="font-size:30px;"></i> Top Up
                    </a>
              </div>
              <div class="col-4">
