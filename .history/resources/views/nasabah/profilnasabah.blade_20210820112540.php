...
<div class="modal fade bs-example-modal-lg" role="dialog" aria-hidden="true" style="margin-top:80px;">
  <div class="modal-dialog modal-lg">
      ...
      <form action="{{ url('nasabah/infosaldo') }}" method="post" id="myForm" name="formData" class="form-horizontal form-label-left" >
          ...
          <div class="modal-body">
                  ...
                  <div class="form-group row ">
                      <div class="col-md-9 col-sm-9 ">
                          <input type="password" name="passlama" value="" class="form-control" required placeholder="Input Password Lama">
                          <input type="password" name="passbaru" value="" class="form-control" required placeholder="Password Baru">
                          <input type="password" name="confirmpass" value="" class="form-control" required placeholder="Confirm Password Baru">
          ...
          <button type="submit" name="submit" id="btn" class="btn btn-primary" value="proses">Ubah Password</button>
          </div>
      </form>     
      </div>
  </div>
