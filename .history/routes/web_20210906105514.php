...
Route::middleware('statuslogin')->group(function () {
    ...
    Route::post('/home/setoran', 'HomeController@setoran')->name('chart_setoran');
    ...
    Route::post('/rekening/cetak', 'RekeningController@cetak')->name('rekening_cetak');
...
Route::get('/payment/notif', 'PaymentController@notif')->name('payment.notif');
