									...
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">      
                                                <input type="radio" class="flat" name="jenis" value="open" checked="" required />Open Payment
                                                <input type="radio" class="flat" name="jenis" value="close" /> Close Payment
										...
										@if(empty($norek))
											<div class="row" id="divTagihan0">
												...
												<div class="col-md-3 col-sm-3">
													...
													<input type="text" id="subnominal[0]" name="subnominal[0]" value="" readonly class="form-control" name="fullname" required />
												</div>
											</div>
										@else
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 col-sm-3 text-md-right text-sm-right text-right">
                                                <br>
                                                <input type="text" id="totalnominal" name="totalnominal" readonly class="form-control" name="fullname" required /> 
                                            </div>
                                        </div>
    ...
    $.ajax(
          {
            ...
            if(hasil.code=="00"){
                $.post( '{{ url("tagihan/lokal") }}' ,{
                    '_token': $('meta[name=csrf-token]').attr('content'),
                    id_record_tagihan: dt.id,
                    nomor_pembayaran: dt.number,
                    nama: dt.name,
                    is_tagihan_aktif: 1,
                    urutan_antrian: 0,
